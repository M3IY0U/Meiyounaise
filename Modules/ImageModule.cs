...
namespace Meiyounaise.Modules
{
    public class ImageModule : BaseCommandModule
    {
        ...
        [Description("Returns information about either an image attachment or an url to an image, also works for the previous message")]
        public async Task ImageRecognition(CommandContext ctx, string imageUrl = "")
        {
            if (imageurl == "")
            {
                ...
                else
                {
                    ...
                    imageurl = messages.Last().Attachments.Count != 0 ? messages.Last().Attachments.First().Url : messages.Last().Content;
                }
            }
            ...
            var eb = new DiscordEmbedBuilder()
                ...
                .WithDescription(responseObject.description.captions.Aggregate("",
                ...
                .AddField("Categories",
                    ...
                    true)
                .AddField("Tags", string.Join(", ", responseObject.description.tags), true)
                .AddField("Colors",
                    $"Foreground Color: {responseObject.color.dominantColorForeground}\nBackground Color: {responseObject.color.dominantColorBackground}\nAccent Color: {responseObject.color.accentColor}",
                    true)
                .AddField("Dimensions",
